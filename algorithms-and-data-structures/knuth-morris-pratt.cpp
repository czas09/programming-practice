 ...
 * complexity: O(n + m)
 * 
 * 1. Preprocess pattern to identity any suffixes that are identical to prefixes. 
 * This tells us where to continue from if we get a mismatch between a character 
 * in our pattern and the text. 
 * 
 * 2. Step through the text one character at a time and compare it to a character 
 * in the pattern updating our location within the pattern if necessary
 */
...
namespace string_search {
     ...
     * @return the partial match table as a vector array
     */
     ...
     * \return s `false` if pattern was not found
     */
